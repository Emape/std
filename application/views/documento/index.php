...
<script>
    $(document).ready(function(){
        ...
        $(".btn-registrar-persona").click(function(){
            if($("#detalle_paterno").val()==""){
                ...
                data : "detalle_paterno="+$('#detalle_paterno').val()+"&detalle_materno="+$('#detalle_materno').val()+"&detalle_nombre="+$('#detalle_nombre').val()+"&unidad="+$('#unidad').val()+"&entidad="+$('#entidad').val(),
                type : 'POST',
                success : function(result) {
                    if(result=='1'){
    ...
    function listar_dependencia(){
        if($("#entidad").val()=='0') $("#agregar_unidad").css("display","none");
